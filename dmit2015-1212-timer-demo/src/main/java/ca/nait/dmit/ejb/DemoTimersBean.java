...
public class DemoTimersBean {        // Also known as Calendar-Based Timers
        ...
        private void sendEmail(Timer timer) {
         ...
         @Schedules({
                 @Schedule(second = "0", minute ="20", hour = "5", dayOfWeek = "Mon,Wed", month = "Jan-Apr", year = "2022", info ="DMIT2015-OA01 Meeting", persistent = false),
        ...
        public void dmit2015SectionOA01ClassNotifiation(Timer timer) {
                ...
                // Create a interval timer that strats in 1 seconds and repeats every 10 seconds and passed in thje jobId to the timer
